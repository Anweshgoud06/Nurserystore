...
<head>
  ...
  <title>Plant Nursery-Cart details</title>
  <!-- bootstrap css link-->
...
<body>
  ...
  <div class="container-fluid p-0">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link" href="#">Call-Us-On: 91-9014380611</a>
            </li>
    ...
    <!-- third child -->
    <div class="bg-light">
      <h3 class="text-center">Plant Paradise</h3>
      <p class="text-center">welcome to online Nursery Store</p>
    </div>
  <!-- fourth child -->
